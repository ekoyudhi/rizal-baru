...
class Player(BasePlayer):
    ...
    #Ins2
    q11a = models.IntegerField(choices=[[1,'17'],[2,'80'],[3,'15']],label='1) Jika Anda mendapatkan pertanyaan seperti ini, maka code angka yang benar adalah:<br><img src="https://i.ibb.co/rd2fsss/image-gr1.jpg" alt="q11" border="0" width="600" height="400"><br>Pilih jawaban di bawah?')
    q11b = models.IntegerField(choices=[[1,'70'],[2,'80'],[3,'76']],label='2) Jika Anda mendapatkan pertanyaan seperti ini, maka code angka yang benar adalah:<br><img src="https://i.ibb.co/WgtYfMD/image-gr2.jpg" alt="q11" border="0" width="600" height="400"><br>Pilih jawaban di bawah?')
    #Ins3
    ...
    q14 = models.IntegerField(choices=[[1,'a'],[2,'b'],[3,'c']],label='3) Jika dalam kondisi nomor 2 dan kemudian Anda diperiksa, berapakah pendapatan bersih Anda setelah dikurangi denda yang harus Anda bayarkan? Tarif denda adalah 200% dikali dengan iuran wajib yang masih kurang dibayar (yaitu: iuran wajib yang sebenarnya dikurangi dengan iuran wajib yang dilaporkan).<br><img src="https://i.ibb.co/VpYJ4qg/q3.png" alt="q14" border="0" width="600" height="250"><br>Pilih jawaban di bawah?')
    q15 = models.IntegerField(choices=[[1,'Tetap 49 juta'],[2,'Naik menjadi 55 juta'],[3,'Turun menjadi 22 juta']],label='4) Jika dalam kondisi nomor 2 (melaporkan omset lebih rendah dari omset usaha) namun Anda tidak termasuk dalam probabilitas pengusaha yang diperiksa, berapakah pendapatan bersih Anda?')
