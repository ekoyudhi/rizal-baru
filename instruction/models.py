...
class Player(BasePlayer):
    ...
    q8 = models.IntegerField(choices=[[1,'a'],[2,'b'],[3,'c'],[4,'d']], label='8) Pilih penghitungan iuran wajib dan pendapatan bersih yang paling tepat (Anda dapat menggunakan kalkulator)<br><img src="https://i.ibb.co/p0DwHt6/q8.png" alt="2022-02-21-195502" border="0" width="600" height="300"><br>Pilih jawaban di bawah?')
    ...
    q11 = models.IntegerField(choices=[[1,'a'],[2,'b'],[3,'c']],label='11) Dari beberapa opsi di bawah ini, pilih hitungan denda yang tepat (Anda dapat menggunakan kalkulator)<br><img src="https://i.ibb.co/PrnvQ1Y/q11.png" alt="q11" border="0" width="600" height="400"><br>Pilih jawaban di bawah?')
    q12 = models.IntegerField(choices=[[1,'a'],[2,'b'],[3,'c']],label='12)	Jika Anda melaporkan omset sebesar 100juta, berapakah pendapatan bersih Anda setelah dikurangi iuran wajib?<br><img src="https://i.ibb.co/cNnKLTJ/q12.png" alt="q12" border="0" width="600" height="300"><br>Pilih jawaban di bawah?')
    q13 = models.IntegerField(choices=[[1,'a'],[2,'b'],[3,'c']],label='13) Jika Anda melaporkan omset hanya sebesar 40juta, berapakah pendapatan bersih Anda setelah dikurangi iuran wajib?<br><img src="https://i.ibb.co/KsQ9CjF/q13.png" alt="q13" border="0" width="600" height="300"><br>Pilih jawaban di bawah?')
    q14 = models.IntegerField(choices=[[1,'a'],[2,'b'],[3,'c']],label='14)	Jika dalam kondisi nomor 13 dan kemudian Anda diperiksa, berapakah pendapatan bersih Anda setelah dikurangi denda yang harus Anda bayarkan?<br><img src="https://i.ibb.co/8K4LtRC/q14.png" alt="q14" border="0" width="600" height="250"><br>Pilih jawaban di bawah?')
