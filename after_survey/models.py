...
class Player(BasePlayer):
    ...
    s3 = models.IntegerField(choices=[[1,"Sudah punya"],[2,"Belum punya"]], label="3) Apakah Sudah memiliki NPWP (Nomor Pokok Wajib Pajak)?")
    ...
    s5 = models.IntegerField(choices=[[1,"Belum pernah"],[2,"Sudah pernah"]], label="5) Jika sudah memiliki NPWP, apakah Anda pernah melaporkan SPT (Surat Pemberitahuan) Pajak?", blank=True)
    ...
    s7 = models.IntegerField(choices=[[1,"Tidak Adil"],[2,"Cukup Adil"],[3,"Adil"],[4,"Sangat Adil"]], label="7) Seberapa adilkah penghitungan kontribusi wajib dalam penelitian ini? (tarif kontribusi wajib dikali dengan omset, bukan dikali laba)")
    s8 = models.IntegerField(choices=[[1,"Tidak Mudah"],[2,"Cukup Mudah"],[3,"Mudah"],[4,"Sangat Mudah"]], label="8) Seberapa mudahkah penghitungan kontribusi wajib dalam penelitian ini?")
    s9 = models.IntegerField(choices=[[1,"Tidak Setuju"],[2,"Cukup Setuju"],[3,"Setuju"],[4,"Sangat Setuju"]], label="9) Seberapa setuju Anda dengan penurunan tarif dari 20% ke 10% di Nusa Makmur?")
    s10 = models.IntegerField(choices=[[1,"Tidak Percaya"],[2,"Cukup Percaya"],[3,"Percaya"],[4,"Sangat Percaya"]], label="10) Seberapa besar kepercayaan Anda terhadap otoritas kontribusi wajib Nusa Makmur terkait dengan perhitungan estimasi prefilled omset yang diterapkan dalam form pelaporan kontribusi wajib?", blank=True)
    s11 = models.IntegerField(choices=[[1,"Tidak tahu"],[2,"Tidak Perlu"],[3,"Cukup Perlu"],[4,"Perlu"],[5,"Sangat Perlu"]], label="11) Seberapa perlukah penerapan prefilled omset dalam form pelaporan kontribusi wajib?", blank=True)
