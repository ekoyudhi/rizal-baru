...
class Player(BasePlayer):
    ...
    s11 = models.IntegerField(choices=[[1,"Sudah punya"],[2,"Belum punya"]], label="11) Apakah Anda Sudah memiliki NPWP (Nomor Pokok Wajib Pajak)?")
    ...
    t17 = models.IntegerField(choices=[[1,"Matrikulasi"],[2,"Semester I"],[3,"Semester II"],[4,"Semester III"],[5,"Semester IV"],[6,"Semester V"],[7,"Semester VI"],[8,"Semester VII"],[9,"Semester VIII"],[10,"Semester IX"],[11,"Semester X"],[12,"Semester XI"],[13,"Semester XII"],[14,"Semester Lainnya"]], label='7)	Saat ini Anda sedang di semester berapa?')
